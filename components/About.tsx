  ...
  return (
    <section id="about" className="max-w-[1120px] mx-auto px-8 py-[70px]">
      <Reveal className="grid grid-cols-1 min-[901px]:grid-cols-[.94fr_1.06fr] gap-9 min-[901px]:gap-16 items-center">
        <div className="min-w-0 bg-brand rounded-[22px] px-8 min-[901px]:px-[38px] py-10 shadow-[0_40px_88px_-44px_rgba(20,57,43,.62)] flex flex-col justify-between min-h-[392px] relative overflow-hidden">
          <span
          ...
          <div className="relative">
            <p className="font-serif font-normal text-[27px] leading-[1.32] text-paper mb-[26px] tracking-[-.01em]">
              Small enough to build you a real receptionist. Serious enough to stand
              behind every call it takes.
            </p>
        ...
        <div className="min-w-0">
          <div className="inline-flex items-center gap-2.5 font-mono font-medium text-[11px] leading-none tracking-[.16em] uppercase text-terracotta mb-6">
          ...
          <p className="font-serif font-normal text-[28px] min-[901px]:text-[35px] leading-[1.28] text-brand mb-[22px] tracking-[-.014em]">
            ...
            <span className="text-terracotta">design the agent, test it, and run it</span>{" "}
